            ...
            <div class="col-md-8">
                <div class="card mb-4">
                    <div class="card-header">
                        <h3 class="mb-0"><i class="bi bi-person-plus me-2"></i>Thêm sinh viên mới</h3>
                    </div>
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="MaSV" class="form-label required-field">Mã sinh viên</label>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">Hỗ trợ các định dạng: JPG, PNG, GIF, JPEG</div>
                                <img id="imagePreview" src="#" alt="Preview" class="image-preview mt-2">
                            </div>
